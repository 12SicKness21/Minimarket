...
export default function BotonWhatsApp() {
  ...
  let numeroFinal = numero.replace(/\D/g, '');
  if (numeroFinal && !numeroFinal.startsWith('34')) {
    numeroFinal = '34' + numeroFinal;
  }

  return (
    <a
      href={`https://wa.me/${numeroFinal}?text=${encodeURIComponent('¡Hola! Tengo una consulta sobre un producto.')}`}
      target="_blank"
